...
def display_message():
    """Displays what is learn in this Chapter"""
    print("Hi! In this Chap 8 of the Erics Python book, I am learning about the concept of functions")
...
include a book title as an argument in the func'''
...
make_shirt('38','My life My Rules!')
...
def make_album(artist_name,album_title,no_of_tracks=''):
    ...
    if no_of_tracks:
        music_album['number_of_track']=no_of_tracks
    return music_album
...
#Commented below exercise so that further ones can run without any issues
'''while True:
    ...
    if album_title=='q':
        break
    no_of_tracks=input("Enter the number of tracks = ")
    print("Enter q anytime to quit")
    if no_of_tracks=='q':
        break
    #music_album=make_album('artist_name':artist_name,'album_title':album_title,'track_record':no_of_tracks)
    music_album = make_album(artist_name, album_title,no_of_tracks)
    print(music_album)'''

'''8-9. Magicians: Make a list of magician’s names. Pass the list to a function 
called show_magicians(), which prints the name of each magician in the list.'''

magicians=['Raju','Balu','Pappu']
...
def make_great(magicians):
    for i in range(len(magicians)):
        magicians[i]='The Great '+magicians[i]
        new_list.append(magicians[i])

make_great(magicians[:])
print("This is output for 8.11")
#show_magicians(magicians)
...
items as the function call provides, and it should print a summary of the sandwich that is being ordered. 
...
sandwich_topping('pepper')
sandwich_topping('extra cheese','chicken','sauce')
...
my_call=build_profile('Manisha','Thakur',job='Real estate',native_place='Himachal')
print(user_profile)
print(my_call)
